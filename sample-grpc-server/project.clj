(defproject sample-grpc-server "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "sample-grpc-server.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.7"]]}
             :uberjar {:aot [sample-grpc-server.server]}}
  :main ^{:skip-aot true} sample-grpc-server.server)
